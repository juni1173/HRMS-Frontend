...
const UpdateSubject = ({ subjectData, CallBack }) => {
    const Api = apiHelper()
    const [loading, setLoading] = useState(false)
    const [typeArr] = useState([])
    const [subjectDetail, setsubjectDetail] = useState({
         title : subjectData.title ? subjectData.title : '',
         type : '',
            ...
            {!loading ? (
                ...
                <Row>
                    <Col md="6" className="mb-1">
                        ...
                        <Input
                            type="text"
                            name="title"
                            defaultValue={subjectDetail.title}
                    ...
                    <Col md="6" className="mb-1">
                       ...
                       Type<Badge color='light-danger'>*</Badge>
                        ...
                        <Select
                            ...
                            name="type"
                            options={typeArr}
                            defaultValue={typeArr.find(pre => pre.value === subjectData.type) ? typeArr.find(pre => pre.value === subjectData.type) :  typeArr[0]}
                    ...
                    <Col md="6" className="mb-1">
                       ...
                       Description
                        ...
                        <Input
                            type="text-area"
                            name="description"
                            defaultValue={subjectDetail.description}
                ...
                <Row>
                    <Col md="12" className="mb-1">
                       <button className="btn-next float-right btn btn-warning" onClick={(e) => UpdateSubjectApi(e)}><span className="align-middle d-sm-inline-block d-none">Update</span></button>
                    </Col>
                </Row>
            </Form>
            ) : (
